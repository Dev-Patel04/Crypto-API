A simple, web-based application that fetches and displays the current prices and 24-hour price changes of several major cryptocurrencies using the CoinGecko API.
